...
public class Triangle {
    ...
    public Triangle() {
        ...
        int vertexShader = ShapeFactoryGLRenderer.loadShader(
                GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = ShapeFactoryGLRenderer.loadShader(
    ...
    public void draw(float[] mvpMatrix) {
        ...
        ShapeFactoryGLRenderer.checkGlError("glGetUniformLocation");
